...
export class LoadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON(constants.LEVEL1KEY, 'json/tutorial.json');
    this.load.tilemapTiledJSON(constants.LEVEL2KEY, 'json/level2.json');
    ...
    this.load.image(constants.DOG4KEY, 'assets/dog4.png');
