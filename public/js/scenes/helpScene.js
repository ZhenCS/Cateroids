let helpScene = new Phaser.Scene(keys.HELPKEY);
...
helpScene.create = function(){
    ...
    this.helpTweens = [this.tween1, this.tween2, this.tween3, this.tween4, this.tween5];
    this.helpCounter = 0;
...
helpScene.addText = function(textString){
...
helpScene.addTween = function(text){
