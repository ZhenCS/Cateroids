let splashScene = new Phaser.Scene(keys.SPLASHKEY);
...
splashScene.initText = function(gameWidth, gameHeight){
    this.startText = this.add.text(0, gameHeight - 150 * gameScale.scale, '- Click to Start -', {
