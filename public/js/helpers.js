...
function setGameName(scene){
    ...
    scene.gameName = scene.add.sprite(gameWidth/2, 160 * gameScale.scale, keys.NAMEKEY);
...
function setBackButton(fromScene, fromSceneString, toSceneString){
    ...
    fromScene.backButton = fromScene.add.sprite(200 * gameScale.scale, gameHeight - 80 * gameScale.scale, keys.BACKKEY).setInteractive({cursor: 'pointer'});
